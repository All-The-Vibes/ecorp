...
| `pnpm check:state-audit-compatibility` | `node tools/check_state_audit_compatibility.mjs` |
| `pnpm check:state-audit-evm` | `cargo test --locked -p crony-audit --test ethereum_local_chain` |
