...
$fixture = '<local-user>\code\qa\pr325-browser-fixture-20260922-r4'
$output = Join-Path $PSScriptRoot 'pr325-native-browser-r4'
$receiptPath = Join-Path $PSScriptRoot 'pr325-browser-receipt-r4.json'
...
& node tools/e2e_verifier_browser.mjs *> (Join-Path $PSScriptRoot 'pr325-browser-r4.log')
