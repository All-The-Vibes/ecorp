...
import { ensureOriginalTrustInputs } from "file:///C:/Users/shyamsridhar/code/ecorp-pr293-completion-20260922/tools/native_qualification_trust.mjs"
...
function query(sql) {
  ...
  const result = spawnSync("C:\\Users\\shyamsridhar\\AppData\\Local\\Programs\\ecorp-tools\\postgresql-17.10\\pgsql\\bin\\psql.exe", ['-h', '127.0.0.1', '-p', '55483', '-U', 'postgres', '-d', 'native_foreground_runtime_20260917', '-At', '-v', 'ON_ERROR_STOP=1', '-c', sql],
