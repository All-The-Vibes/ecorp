...
import { startSurface, supplementalState } from "file:///C:/Users/shyamsridhar/code/ecorp/output/pr-completion/20260922T123548Z/pr293-full-native-r5/native_qualification_attempt.mjs"
import { verifyFinalityObservations } from "file:///C:/Users/shyamsridhar/code/ecorp-pr293-completion-20260922/tools/native_qualification_finality.mjs"
...
const root = "C:\\Users\\shyamsridhar\\code\\ecorp-pr293-completion-20260922"
const output = path.join(root, 'output', 'native-qualification', 'phase2-r5')
...
function query(sql, journal = false) {
  ...
  const result = spawnSync("C:\\Users\\shyamsridhar\\AppData\\Local\\Programs\\ecorp-tools\\postgresql-17.10\\pgsql\\bin\\psql.exe", ['-h', '127.0.0.1', '-p', '55483', '-U', 'postgres', '-d', journal ? 'native_foreground_journal_20260917' : 'native_foreground_runtime_20260917',
