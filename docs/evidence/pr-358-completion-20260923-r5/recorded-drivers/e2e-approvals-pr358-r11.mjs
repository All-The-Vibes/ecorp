...
import { restartOwnedTestServer } from "file:///C:/Users/shyamsridhar/code/ecorp-pr358-completion-20260922/tools/owned_test_stack.mjs"
import { writeFile } from 'node:fs/promises'
import path from 'node:path'

const server = process.env.CRONY_SERVER_HTTP ?? 'http://127.0.0.1:8791'
const root = "C:\\Users\\shyamsridhar\\code\\ecorp-pr358-completion-20260922"
...
await writeFile(
  path.join(process.env.ECORP_COMPLETION_QA_ROOT, 'evidence', 'approval-execution.json'),
