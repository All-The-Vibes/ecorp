...
import { verifyFinalityObservations } from "file:///<reviewed-worktree>/tools/native_qualification_finality.mjs"
...
function query(sql, journal = false) {
  ...
  const result = spawnSync("<local-user>\\AppData\\Local\\Programs\\ecorp-tools\\postgresql-17.10\\pgsql\\bin\\psql.exe", ['-h', '127.0.0.1', '-p', '55483', '-U', 'postgres', '-d', journal ? 'native_foreground_journal_20260917' : 'native_foreground_runtime_20260917',
