...
export const root = "<reviewed-worktree>"
export const output = path.join(root, 'output', 'native-qualification', 'phase2-queue-r471')
...
export async function identity() {
  ...
  execFileSync('pwsh', ['-NoProfile', '-NonInteractive', '-Command',
    ...
    "$s=Get-Content .\\output\\native-qualification\\phase2-queue-r471\\processes.json -Raw | ConvertFrom-Json -AsHashtable; " +
