...
assert.match(root ?? '', /[\\/]qa[\\/]pr265-run-activity-pr355-[a-zA-Z0-9-]+$/);
...
console.log(JSON.stringify({check:'focused-credential-preflight',status:'passed',forbidden_variable_names:forbidden}));
