...
try{
  ...
  $receipt.prior_failed_attempt='r1/r2 retained: baseline receipt and role-denial status expectations corrected against the implemented API contract.'
  Save-Receipt
  ...
  & node (Join-Path $PSScriptRoot 'pr283-browser-state-audit-20260923-r3.mjs') *> $log
