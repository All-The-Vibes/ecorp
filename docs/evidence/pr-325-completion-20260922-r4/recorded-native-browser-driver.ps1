...
$fixture = '<local-user>\code\qa\pr325-browser-fixture-20260922-r6'
$output = Join-Path $PSScriptRoot 'pr325-native-browser-r6'
$receiptPath = Join-Path $PSScriptRoot 'pr325-browser-receipt-r6.json'
...
& node tools/e2e_verifier_browser.mjs *> (Join-Path $PSScriptRoot 'pr325-browser-r6.log')
