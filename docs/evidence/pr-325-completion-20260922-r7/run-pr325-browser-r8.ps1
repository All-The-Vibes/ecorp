...
$fixture = '<local-user>\code\qa\pr325-browser-fixture-20260922-r8'
$output = Join-Path $PSScriptRoot 'pr325-native-browser-r8'
$receiptPath = Join-Path $PSScriptRoot 'pr325-browser-receipt-r8.json'
...
$validation = Get-Content -LiteralPath (Join-Path $PSScriptRoot 'pr325-validation-r13/validation.json') -Raw | ConvertFrom-Json
...
& node tools/e2e_verifier_browser.mjs *> (Join-Path $PSScriptRoot 'pr325-browser-r8.log')
