...
Save-Receipt
$supervisor = Join-Path $PSScriptRoot 'qa-pr359-stack-r1.ps1'
$serverPort = 59031
$webPort = 59032
$databasePort = 59030
try {
  ...
  if ($Number -eq 359) {
    ...
    $env:DATABASE_URL = "postgres://issue48@127.0.0.1:$databasePort/postgres"
    With-Cargo {
      ...
      & cargo test @packages $filter -- --ignored --test-threads=1 *> $log
