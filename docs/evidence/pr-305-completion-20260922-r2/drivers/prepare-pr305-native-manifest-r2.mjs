...
const receipt = path.join(base, 'pr305-native-r2-build/cargo-test.jsonl')
...
await writeFile(path.join(base, 'pr305-native-r2-manifest.json'), JSON.stringify(manifest, null, 2) + '\n', { flag: 'wx' })
