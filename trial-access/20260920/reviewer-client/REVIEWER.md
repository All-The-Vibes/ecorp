...
Run this on your Windows client computer in trusted **PowerShell 7.4 or later**. This bundle includes the reviewed `trial-config.json` for tunnel **`ecorp-owner-20260919-4e1fd07a.usw3`**. The trial expires at **2026-09-21 17:40:00 UTC**. Do not add tokens to the config or change the fixed tenant/user allowlist.
